...
static void expectSorted(const char *name, void (*sort)(int[], int), int input[],
...
int main(void) {
    {
        ...
        expectSorted("삽입 정렬: 섞인 배열", insertionSort, a, want, 10);
    }
    {
        int a[] = {1, 2, 3, 4, 5};
        const int want[] = {1, 2, 3, 4, 5};
        expectSorted("삽입 정렬: 이미 정렬된 배열", insertionSort, a, want, 5);
    }
    {
        int a[] = {5, 4, 3, 2, 1};
        const int want[] = {1, 2, 3, 4, 5};
        expectSorted("삽입 정렬: 역순 배열", insertionSort, a, want, 5);
    }
    {
        int a[] = {3, 1, 3, 1, 2};
        const int want[] = {1, 1, 2, 3, 3};
        expectSorted("삽입 정렬: 중복이 있는 배열", insertionSort, a, want, 5);
    }
    {
        int a[] = {42};
        const int want[] = {42};
        expectSorted("삽입 정렬: 원소 하나", insertionSort, a, want, 1);
    }
    {
